...
public class ProductServiceImpl implements ProductService {
    ...
    private void loadProducts() {
        ...
        Author es = new Author();
        es.setFirstName("Eduardo");
        es.setLastName("Solis");
        es.setId(1);
        es.setImage("instructor_jt.jpg");
        ...
        springCoreUltimate.setAuthor(es);
